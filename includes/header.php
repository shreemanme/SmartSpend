...
<head>
    ...
    <meta name="theme-color" content="#12c48b">
    <title><?= isset($pageTitle) ? htmlspecialchars($pageTitle, ENT_QUOTES, 'UTF-8') . ' — SmartSpend' : 'SmartSpend' ?></title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Open+Sans:wght@300;400;600;700&display=swap" rel="stylesheet">
            ...
            <ul class="navbar-links" id="nav-links" role="list">
                <?php if (isset($_SESSION['user_id'])): ?>
                    <?php if (($_SESSION['role'] ?? '') === 'admin'): ?>
                        <li><a href="/smartspend/admin/index.php" <?= nav_active('admin') ?>>Admin Dashboard</a></li>
